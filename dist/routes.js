...
const collection_4 = __importDefault(require("./linkSection/controller/collection"));
...
const collection_5 = __importDefault(require("./attendee/controller/collection"));
const item_4 = __importDefault(require("./attendee/controller/item"));
const item_5 = __importDefault(require("./linkSection/controller/item"));
exports.default = [
    ...
    router_1.default("/attendee", new collection_5.default()),
    ...
    router_1.default("/linkSection/:id", new item_5.default()),
    router_1.default("/linkSection", new collection_4.default()),
];
